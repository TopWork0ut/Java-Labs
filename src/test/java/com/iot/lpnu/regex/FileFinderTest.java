...
class FileFinderTest {
	...
	public void testFindingAppropriateFilesFromText() {
	    ...
	    assertEquals("[kjk2345.doc, jdks.sjal2345.txt, ajsd:8%23оа1Ро2345олва2345.txt]",
	            String.valueOf(fileFinder.findAndPrintIdentifiedFilesInText()));   
	...
	private void printInputOfDataInScanner(Integer lastNumbers,String imaginedInputedTextByConsole) {
        ByteArrayInputStream in = new ByteArrayInputStream((lastNumbers 
                + System.lineSeparator() + imaginedInputedTextByConsole).getBytes());
        System.setIn(in);
    }
